...
my_list_with_non_numbers = [1,2,'a',4,5]
average_with_non_numbers = calculate_average(my_list_with_non_numbers)
print(f"The average with non numbers is: {average_with_non_numbers}")
